...
│       ├── README.md               # the crates.io front page; its Rust blocks are doctests
│       ├── CHANGELOG.md            # the crate's API changelog and its semver promise
│       ├── public-api.txt          # the published surface; `scripts/vt-public-api.py` gates it
