# Historical: vendored `gpui-component` maintenance

> Archived on 2026-09-07 after OneTerm migrated to the published GPUI Kit 0.6 family. Retained only as historical rationale; do not follow this procedure for current dependency work.
