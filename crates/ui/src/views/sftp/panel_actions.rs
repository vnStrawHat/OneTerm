...
impl SftpPanel {
    ...
    pub(crate) fn on_action_sftp_properties(
        &mut self,
        _: &crate::actions::SftpProperties,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(crate) fn on_action_sftp_upload_files(
        &mut self,
        _: &crate::actions::SftpUploadFiles,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(crate) fn on_action_sftp_upload_folder(
        &mut self,
        _: &crate::actions::SftpUploadFolder,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
