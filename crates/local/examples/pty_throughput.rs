...
//!
//! Usage:
//!   cargo run -p oneterm-local --release --example pty_throughput -- <program> [args...]
//! Example (Windows):
//!   cargo run -p oneterm-local --release --example pty_throughput -- cmd /c type C:\Temp\plain.txt
