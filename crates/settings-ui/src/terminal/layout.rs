    ...
    SettingGroup::new().title("Layout").items(vec![
        ...
        SettingItem::new(
            ...
            SettingField::dropdown(
                ...
                |cx: &App| {
                    SharedString::from(match TerminalSettings::global(cx).read(cx).tab_title_mode {
        ...
        .description("A fixed label, or the title the shell sets."),
        SettingItem::new(
            "Scrollback History",
        ...
        .description("Lines kept above the screen."),
    ])
}
