...
use super::super::element::TerminalElement;
use super::super::theme::{TerminalTheme, build_terminal_theme};
use super::super::view::LocalTerminalView;
use super::theme_apply;
    ...
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl gpui::IntoElement {
        ...
        let terminal_div = div()
            ...
            .child(TerminalElement {
                ...
                render_cache: super::super::layout::types::TerminalRenderCache {
